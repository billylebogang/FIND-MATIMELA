...
foundAnimalsCtn.style.backgroundColor = "red"; //used to check if the JAVASCRIPT is working to remove on submit
    ...
    for(i=0; i<foundAnimals.length;i++){
        ...
        animaldiv.innerHTML= `
            ...
            <div class="btn-group">
                        ...
                        <button type="button" class="btn btn-sm btn-outline-secondary">Claim</button>          
             </div>
            </div>
